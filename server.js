...
const viewQueries = require('./helpers/view-queries');
const addQueries = require('./helpers/add-queries');
    ...
    inquirer.prompt([
        {
            ...
            choices: ['View all departments', 'View all roles', 'View all employees', 'Add a department', 'Add a role', 'Add an employee', 'Update employee role', 'Exit out']
        },
        {
            type: 'input',
            name: 'departmentName',
    ...
    .then(answer => {
        ...
        switch (answer.userInput) {
            ...
            case 'Add an employee':
                ...
                sql = addQueries.newEmployee(empFirstName, empLastName, empRole, empsMan);
